...
class Login extends React.Component<IProps, IState> {
  ...
  handleRegister = () => {
    ...
    register(formRegister.userName, formRegister.userPwd2)
      .then((res: any) => {
        if (res.code === 0) {
          this.clearInput();
          ...
          <div className="login-box">
            ...
            <div className="right-content">
              ...
              <Button
                ...
                disabled={!formLogin.userName || !formLogin.userPwd}
              >
                立即登录
              </Button>
              <div className="option">
                ...
                <span className="forget-pwd" onClick={this.forgetPwd}>
                  忘记密码?
                </span>
              </div>
            </div>
...
export default withRouter(
  connect((state: any) => state.user, { login, register })(Login)
);
